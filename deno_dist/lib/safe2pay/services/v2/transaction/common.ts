import type { CustomerType, ProductType } from '../../common.ts';
import type { PaymentMethodEnum, TransactionStatusEnum } from '../../constants.ts';
import type { BaseBoletoResponse } from '../payments/boleto/index.ts';
import type { BaseCreditCardResponse } from '../payments/creditCard/index.ts';
import type { CreateCryptocurrencyResponse } from '../payments/cryptocurrency/index.ts';
